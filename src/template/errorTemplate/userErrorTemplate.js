...
const BIO_INVALID_TYPE = errorTemplateGenerator(4024, "", "BIO_INVALID_TYPE", "1.0.0");

const BIO_MAXLENGTH_REACH = errorTemplateGenerator(4025, "", "BIO_MAXLENGTH_REACH", "1.0.0");

const BIO_MINLENGTH_REACH = errorTemplateGenerator(4026, "", "BIO_MINLENGTH_REACH", "1.0.0");

const CELLPHONE_EXIST = errorTemplateGenerator(4027, "", "CELLPHONE_EXIST", "1.0.0");
...
const CELLPHONE_NOT_EXIST = errorTemplateGenerator(4031, "", "CELLPHONE_NOT_EXIST", "1.0.0");

const CELLPHONE_REQUIRED = errorTemplateGenerator(4032, "", "CELLPHONE_REQUIRED", "1.0.0");
...
const CONTACT_INVALID_TYPE = errorTemplateGenerator(4034, "", "CONTACT_INVALID_TYPE", "1.0.0");
...
const FIRST_NAME_REQUIRED = errorTemplateGenerator(4047, "", "FIRST_NAME_REQUIRED", "1.0.0");
...
const MAC_ADDRESS_EXIST = errorTemplateGenerator(4051, "", "MAC_ADDRESS_EXIST", "1.0.0");
...
const MAC_ADDRESS_REQUIRED = errorTemplateGenerator(4055, "", "MAC_ADDRESS_REQUIRED", "1.0.0");
...
const PHONE_NUMBER_EXIST = errorTemplateGenerator(4057, "", "PHONE_NUMBER_EXIST", "1.0.0");
...
const PRIVATE_ID_EXIST = errorTemplateGenerator(4061, "", "PRIVATE_ID_EXIST", "1.0.0");
...
const PRIVATE_ID_REQUIRED = errorTemplateGenerator(4065, "", "PRIVATE_ID_REQUIRED", "1.0.0");
...
const TOKEN_REQUIRED = errorTemplateGenerator(4068, "", "TOKEN_REQUIRED", "1.0.0");

const TOKEN_INVALID_TYPE = errorTemplateGenerator(4069, "", "TOKEN_INVALID_TYPE", "1.0.0");
...
const USERNAME_EXIST = errorTemplateGenerator(4071, "", "USERNAME_EXIST", "1.0.0");
