const UNIQUE_ERROR_IDS = {
  ...
  CREATED_AT_EMPTY: "CREATED_AT_EMPTY",
  ...
  INPUT_DATA_NOT_DEFINED: "INPUT_DATA_NOT_DEFINED",
  INPUT_FIELD_INVALID_TYPE: "INPUT_FIELD_INVALID_TYPE",
  INPUT_FIELDS_MISSING: "INPUT_FIELDS_MISSING",
  INPUT_FIELDS_OVERLOAD: "INPUT_FIELDS_OVERLOAD",
  IS_NOT_A_CALLBACK: "IS_NOT_A_CALLBACK",
  ...
  MESSAGE_ID_EMPTY: "MESSAGE_ID_EMPTY",
  ...
  MESSAGES_INVALID_TYPE: "MESSAGES_INVALID_TYPE",
  MESSAGES_REQUIRED: "MESSAGES_REQUIRED",
  METHOD_NOT_ALLOWED: "METHOD_NOT_ALLOWED",
  ONLINE_INVALID_TYPE: "ONLINE_INVALID_TYPE",
  ONLINE_REQUIRED: "ONLINE_REQUIRED",
  OUTPUT_DATA_NOT_DEFINED: "OUTPUT_DATA_NOT_DEFINED",
  OUTPUT_FIELD_INVALID_TYPE: "OUTPUT_FIELD_INVALID_TYPE",
  ...
  PARTICIPANT_ID_EMPTY: "PARTICIPANT_ID_EMPTY",
  ...
  PARTICIPANTS_INVALID_LENGTH: "PARTICIPANTS_INVALID_LENGTH",
  PARTICIPANTS_INVALID_TYPE: "PARTICIPANTS_INVALID_TYPE",
  ...
  PRIVATE_CHATS_INVALID_TYPE: "PRIVATE_CHATS_INVALID_TYPE",
  REQUEST_BODY_IS_UNDEFINED: "REQUEST_BODY_IS_UNDEFINED",
  REQUIRED_FIELD_INVALID: "REQUIRED_FIELD_INVALID",
  REQUIRED_FIELD_INVALID_TYPE: "REQUIRED_FIELD_INVALID_TYPE",
  ...
  SERVER_CRITICAL_ERROR: "SERVER_CRITICAL_ERROR",
  SESSIONS_INVALID_TYPE: "SESSIONS_INVALID_TYPE",
  ...
  TEMPORARY_CLIENT_NOT_VERIFIED: "TEMPORARY_CLIENT_NOT_VERIFIED",
