...
const PRIVATE_ID_EXIST = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_EXIST)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();

const PRIVATE_ID_INVALID_TYPE = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_INVALID_TYPE)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();

const PRIVATE_ID_INVALID = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_INVALID)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();

const PRIVATE_ID_MAX_LENGTH_REACH = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_MAX_LENGTH_REACH)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();

const PRIVATE_ID_MIN_LENGTH_REACH = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_MIN_LENGTH_REACH)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();

const PRIVATE_ID_REQUIRED = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_REQUIRED)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();

const PRIVATE_ID_EMPTY = errorBuilder
  .create()
  .errorReason(UNIQUE_ERROR_IDS.PRIVATE_ID_EMPTY)
  .errorKey(PRIVATE_ID_VALIDATION)
  .build();
