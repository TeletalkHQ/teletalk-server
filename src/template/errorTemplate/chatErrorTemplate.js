const { errorTemplateGenerator } = require("~/function/utility/generators");
...
const CHAT_ID_EXIST = errorTemplateGenerator(4001, "", "CHAT_ID_EXIST", "1.0.0");

const CHAT_ID_INVALID_TYPE = errorTemplateGenerator(4002, "", "CHAT_ID_INVALID_TYPE", "1.0.0");
...
const CHAT_ID_REQUIRED = errorTemplateGenerator(4005, "", "CHAT_ID_REQUIRED", "1.0.0");
...
const MESSAGE_ID_EXIST = errorTemplateGenerator(4008, "", "MESSAGE_ID_EXIST", "1.0.0");
...
const MESSAGE_ID_REQUIRED = errorTemplateGenerator(4012, "", "MESSAGE_ID_REQUIRED", "1.0.0");
...
const PARTICIPANT_ID_EXIST = errorTemplateGenerator(4016, "", "PARTICIPANT_ID_EXIST", "1.0.0");
