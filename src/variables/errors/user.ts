...
const BIO_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.BIO_VALIDATION)
  .build();
...
const BLACKLIST_ITEM_EXIST = errorBuilder
  ...
  .errorKey(ERROR_KEYS.BLACKLIST_VALIDATION)
  .build();
...
const CELLPHONE_EXIST = errorBuilder
  ...
  .errorKey(ERROR_KEYS.CELLPHONE_VALIDATION)
  .build();
...
const CHAT_EXIST = errorBuilder
  ...
  .errorKey(ERROR_KEYS.CHAT_VALIDATION)
  .build();
...
const CHAT_ID_EMPTY = errorBuilder
  ...
  .errorKey(ERROR_KEYS.CHAT_ID_VALIDATION)
  .build();
...
const COUNTRY_CODE_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.COUNTRY_CODE_VALIDATION)
  .build();
...
const FIRST_NAME_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.FIRST_NAME_VALIDATION)
  .build();
...
const FULL_NAME_INVALID = errorBuilder
  ...
  .errorKey(ERROR_KEYS.FULL_NAME_VALIDATION)
  .build();

const INPUT_FIELDS_MISSING = errorBuilder
  .create()
  .errorKey(ERROR_KEYS.INPUT_OUTPUT_FIELDS)
...
const IS_NOT_A_CALLBACK = errorBuilder
  .create()
  .errorKey(ERROR_KEYS.SOCKET_ARGS_VALIDATION)
...
const LAST_NAME_INVALID = errorBuilder
  ...
  .errorKey(ERROR_KEYS.LAST_NAME_VALIDATION)
  .build();
...
const MAC_ADDRESS_EMPTY = errorBuilder
  ...
  .errorKey(ERROR_KEYS.MAC_ADDRESS_VALIDATION)
  .build();
...
const MESSAGE_ID_EMPTY = errorBuilder
  ...
  .errorKey(ERROR_KEYS.MESSAGE_ID_VALIDATION)
  .build();
...
const MESSAGE_TEXT_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.MESSAGE_TEXT_VALIDATION)
  .build();
...
const MESSAGES_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.MESSAGES_VALIDATION)
  .build();
...
const METHOD_NOT_ALLOWED = errorBuilder
  .create()
  .errorKey(ERROR_KEYS.EXTERNAL_APP_ERROR)
...
const PRIVATE_CHATS_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.PRIVATE_CHAT_VALIDATION)
  .build();
...
const SELF_STUFF = errorBuilder
  ...
  .errorKey(ERROR_KEYS.SELF_STUFF_VALIDATION)
  .build();

const PARTICIPANT_EMPTY = errorBuilder
  .create()
  .reason(UNIQUE_ERROR_IDS.PARTICIPANT_EMPTY)
  .errorKey(ERROR_KEYS.PARTICIPANT_VALIDATION)
  .build();

const PARTICIPANTS_EMPTY = errorBuilder
  .create()
  .reason(UNIQUE_ERROR_IDS.PARTICIPANT_EMPTY)
  .errorKey(ERROR_KEYS.PARTICIPANTS_VALIDATION)
  .build();
...
const PARTICIPANT_ID_EXIST = errorBuilder
  ...
  .errorKey(ERROR_KEYS.PARTICIPANT_ID_VALIDATION)
  .build();
...
const ROUTE_NOT_FOUND = errorBuilder
  .create()
  .errorKey(ERROR_KEYS.UNKNOWN_ROUTE)
...
const SENDER_EMPTY = errorBuilder
  ...
  .errorKey(ERROR_KEYS.SENDER_ID_VALIDATION)
  .build();
...
const SESSIONS_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.SESSIONS_VALIDATION)
  .build();
...
const STATUS_INVALID_TYPE = errorBuilder
  ...
  .errorKey(ERROR_KEYS.STATUS_VALIDATION)
  .build();
...
const TARGET_USER_NOT_EXIST = errorBuilder
  ...
  .errorKey(ERROR_KEYS.TARGET_USER_VALIDATION)
  .build();

const TOKEN_EXIST = errorBuilder
  .create()
  .reason(UNIQUE_ERROR_IDS.TOKEN_EXIST)
  .errorKey(ERROR_KEYS.TOKEN_VALIDATION)
  .build();
...
const TEMPORARY_CLIENT_NOT_FOUND = errorBuilder
  ...
  .errorKey(ERROR_KEYS.TEMPORARY_CLIENT_VALIDATION)
  .build();
...
const USER_ID_EXIST = errorBuilder
  ...
  .errorKey(ERROR_KEYS.USER_ID_VALIDATION)
  .build();
...
const USERNAME_EMPTY = errorBuilder
  ...
  .errorKey(ERROR_KEYS.USERNAME_VALIDATION)
  .build();
...
const VERIFICATION_CODE_INVALID = errorBuilder
  ...
  .errorKey(ERROR_KEYS.VERIFICATION_CODE_VALIDATION)
  .build();
